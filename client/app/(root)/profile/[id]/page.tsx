...
export default async function Page({ params, searchParams }: URLProps) {
  ...
  return (
    <>
        ...
        <div className='flex flex-col items-start gap-4 lg:flex-row'>
          ...
          <div className='mt-3'>
            ...
            <div className='mt-5 flex flex-wrap items-center justify-start gap-5'>
              ...
              <ProfileLink imgUrl='/assets/icons/calendar.svg' title={dayjs(userInfo.user.joinedAt).format('MMM YYYY')} />
            </div>
      ...
      <Stats reputation={userInfo.reputation} totalQuestions={userInfo.totalQuestions} totalAnswers={userInfo.totalAnswers} />
